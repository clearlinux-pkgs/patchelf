...
Version  : 0.12
Release  : 4
URL      : https://github.com/NixOS/patchelf/archive/0.12/patchelf-0.12.tar.gz
Source0  : https://github.com/NixOS/patchelf/archive/0.12/patchelf-0.12.tar.gz
...
%prep
%setup -q -n patchelf-0.12
cd %{_builddir}/patchelf-0.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599069439
...
cp %{_builddir}/patchelf-0.12/COPYING %{buildroot}/usr/share/package-licenses/patchelf/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
