...
Version  : 0.15.0
Release  : 9
URL      : https://github.com/NixOS/patchelf/archive/0.15.0/patchelf-0.15.0.tar.gz
Source0  : https://github.com/NixOS/patchelf/archive/0.15.0/patchelf-0.15.0.tar.gz
...
%prep
%setup -q -n patchelf-0.15.0
cd %{_builddir}/patchelf-0.15.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658249961
...
cp %{_builddir}/patchelf-0.15.0/COPYING %{buildroot}/usr/share/package-licenses/patchelf/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
