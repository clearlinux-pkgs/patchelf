...
Version  : 0.17.2
Release  : 13
URL      : https://github.com/NixOS/patchelf/archive/0.17.2/patchelf-0.17.2.tar.gz
Source0  : https://github.com/NixOS/patchelf/archive/0.17.2/patchelf-0.17.2.tar.gz
...
%prep
%setup -q -n patchelf-0.17.2
cd %{_builddir}/patchelf-0.17.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673385078
