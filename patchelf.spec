...
Version  : 0.17.0
Release  : 12
URL      : https://github.com/NixOS/patchelf/archive/0.17.0/patchelf-0.17.0.tar.gz
Source0  : https://github.com/NixOS/patchelf/archive/0.17.0/patchelf-0.17.0.tar.gz
...
%prep
%setup -q -n patchelf-0.17.0
cd %{_builddir}/patchelf-0.17.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667841898
