...
Version  : 0.11
Release  : 3
URL      : https://github.com/NixOS/patchelf/archive/0.11/patchelf-0.11.tar.gz
Source0  : https://github.com/NixOS/patchelf/archive/0.11/patchelf-0.11.tar.gz
...
%prep
%setup -q -n patchelf-0.11
cd %{_builddir}/patchelf-0.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591755663
...
cp %{_builddir}/patchelf-0.11/COPYING %{buildroot}/usr/share/package-licenses/patchelf/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
