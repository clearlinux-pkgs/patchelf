...
Version  : 0.16.1
Release  : 11
URL      : https://github.com/NixOS/patchelf/archive/0.16.1/patchelf-0.16.1.tar.gz
Source0  : https://github.com/NixOS/patchelf/archive/0.16.1/patchelf-0.16.1.tar.gz
...
%prep
%setup -q -n patchelf-0.16.1
cd %{_builddir}/patchelf-0.16.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666970150
