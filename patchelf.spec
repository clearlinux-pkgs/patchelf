...
Source0  : https://github.com/NixOS/patchelf/archive/0.14.2/patchelf-0.14.2.tar.gz
...
%prep
%setup -q -n patchelf-0.14.2
cd %{_builddir}/patchelf-0.14.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638627013
...
cp %{_builddir}/patchelf-0.14.2/COPYING %{buildroot}/usr/share/package-licenses/patchelf/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
